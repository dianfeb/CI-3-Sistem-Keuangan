<div class="container-xl">
    ...
    <div class="modal modal-blur fade" id="general_modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <form action="<?= base_url() ?>Nasabah/crud_nasabah" method="POST" onSubmit="validasi()" enctype="multipart/form-data">
                        ...
                        <div class="row">
                           <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="dusun" name="dusun" class="form-control" placeholder="Masukkan Negara">
                                </div>
                            </div>
    ...
    <div class="modal modal-blur fade" id="edit_modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
        <form action="<?= base_url() ?>nasabah/edit_nasabah" method="POST" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Kode Nasabah</label>
                                <input type="text" class="form-control" name="kd_pelanggan" id="kd_pelanggan-edit" readonly></input>
                                <input type="hidden" class="form-control" name="id_pelanggan" id="id_pelanggan-edit" readonly></input>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Nama Lengkap</label>
                                <select  class="form-control" name="nama-nasabah" id="nama-nasabah-edit" ></select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Nomor Handphone</label>
                                <input type="text" class="form-control" name="no_hp" id="no_hp-edit"></input>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Nomor KTP</label>
                                <input type="text" class="form-control" name="no_ktp" id="no_ktp-edit"></input>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Tanggal Lahir</label>
                                <input type="text" class="form-control" name="tgl_lahir" id="tgl_lahir-edit"></input>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Email</label>
                                <input type="text" class="form-control" name="email" id="email-edit"></input>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Negara</label>
                                <input type="text" class="form-control" name="negara" id="negara-edit"></input>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Provinsi</label>
                                <input type="text" class="form-control" name="provinsi" id="provinsi-edit"></input>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Kabupaten</label>
                                <input type="text" class="form-control" name="kabupaten" id="kabupaten-edit"></input>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Kecamatan</label>
                                <input type="text" class="form-control" name="kecamatan" id="kecamatan-edit"></input>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Desa</label>
                                <input type="text" class="form-control" name="kelurahan" id="kelurahan-edit"></input>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Dusun</label>
                                <input type="text" class="form-control" name="dusun" id="dusun-edit"></input>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Pekerjaan</label>
                                <input type="text" class="form-control" name="pekerjaan" id="pekerjaan-edit"></input>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">No Izin Usaha</label>
                                <input type="text" class="form-control" name="no_usaha" id="no_usaha-edit"></input>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Upload KTP <span class="" style="color:red;">(jika ada)</span></label>
                                <img style="width:100px;height:auto;" name="ktp" src="" id="ktp-edit" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Nomor Pokok Wajib Pajak <span class="" style="color:red;">(jika ada)</span></label>
                                <img style="width:100px;height:auto;" class="form-control" name="npwpw" src="" id="npwp-edit" alt="">
                                <input type="file" class="input-group-text" for="inputGroupFile02">Upload</input>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Upload Izin Usaha <span class="" style="color:red;">(jika ada)</span></label>
                                <img style="width:100px;height:auto;" name="izin_usaha" src="" id="izin_usaha-edit" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Nomor Rekening <span class="" style="color:red;">(jika ada)</span></label>
                                <input type="text" class="form-control" name="norek" id="norek-edit"></input>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Nama Pemilik Rekening</label>
                                <input type="text" class="form-control" name="pemilik" id="pemilik-edit" ></input>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Kontak Darurat</label>
                                <input type="text" class="form-control" name="no_darurat" id="no_darurat-edit" ></input>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Hubungan Keluraga</label>
                                <input type="text" class="form-control" name="status_klg" id="status_klg-edit" ></input>
                            </div>
                        </div>
                    </div>
