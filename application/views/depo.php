...
// echo $kalidepo;
$totaldeposaldo = "Rp " . number_format($totaldepo, 0, ',', '.');
            ...
            <div class="col-12 mt-4">
                <div class="card">
                    ...
                    <div class="m-2">
                        ...
                        <div class="row profile">
                            <div class="col-md-3">Total Deposit</div>
                            <div class="col-md-6" id="total_depo"><?= $totaldeposaldo; ?> (<?= $kalidepo; ?> kali Deposit)</div>
                        </div>
                        <div class="row profile">
...
<div class="modal modal-blur fade" id="gambar_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form action="<?= base_url() ?>Transaksi/crud_keuangan" method="POST" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="row">
                    <img src="" id="detail_gambar_bukti" alt="">
                </div>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12"> <label class="form-label">Kode Transaksi</label>
                            ...
                            <input type="hidden" name="jenis" value="Deposit" id="jenis_transaksi_keuangan" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="detail-alamat-add" readonly>
                        </div>
                        <div class="col-md-6">
...
<div class="modal modal-blur fade" id="edit_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <form action="<?= base_url() ?>keuangan/edit_keuangan" method="POST" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="modal-title" id="title-modal">
                        <h5>Tambah Data Keuangan</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12"> <label class="form-label">Kode Transaksi</label>
                            ...
                            <input type="hidden" name="jenis" value="Deposit" id="jenis_transaksi_keuangan" class="form-control" readonly>
                            <input type="hidden" name="id_pelanggan" value="" id="id_pelanggan_depo" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="mb-3">
    ...
    $('#nama-nasabah-penarikan').change(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var data = JSON.parse(response);
                // console.log(data);
                $('#detail-alamat-penarikan').val(data.dusun);
