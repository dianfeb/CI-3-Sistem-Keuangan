                ...
                <div class="card">
                    <div class="card-header">
                        <ul class="nav nav-tabs nav-fill" data-bs-toggle="tabs">
                            <li class="nav-item">
                                <a href="#pemasukan" value="Deposit" onclick="jenis('Deposit')" class="nav-link active" data-bs-toggle="tab">Setor Tunai & Transfer</a>
                            </li>
                            <li class="nav-item">
                                <a href="#pemasukan" value="Penarikan" onclick="jenis('Penarikan')" class="nav-link" data-bs-toggle="tab">Penarikan</a>
                            </li>
                        </ul>
                    </div>
                    <div class="row m-2">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="nasabah" class="form-control" id="nama-nasabah">
                                ...
                                <?php foreach ($plg as $plg) : ?>
                                    <option value="<?= $plg->id_pelanggan; ?>"><?= $plg->nama_lengkap; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12"> <label class="form-label">Kode Transaksi</label>
                            <input type="text" name="id_keuangan" value="<?= $id_keuangan; ?>" class="form-control" readonly>
                            <!-- <input type="text" name="kd_keuangan" value="<?= $id_keuangan; ?>" class="form-control" readonly> -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-selectgroup-boxes row mb-3" id="jenis-detail">
                    <div class="col-lg-6">
                        <a href="" style="text-decoration:none;" class="depo-tunai-keuangan">
                            <span class="form-selectgroup-label d-flex align-items-center p-3">
                                <span class="me-3">
    ...
    $('#nama-nasabah-penarikan').change(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#detail-ktp-penarikan').val(data.no_ktp);
