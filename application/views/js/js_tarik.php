                ...
                // },
                {
                    ...
                    render: function(k, v, r) {
                        ...
                        <div class="col-4 col-sm-3 col-md-2 col-xl-auto mb-3">
                                <button class="btn btn-info w-50 btn-sm  btn-icon" title="Detail Data" onclick="cetak(\'` + r.id_keuangan + `\')">
    ...
    function add() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#detail-alamat').val(response.data[0].dusun);
    ...
    function edit(id) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#id-pelanggan-depo').val(response.data[0].id_pelanggan);
