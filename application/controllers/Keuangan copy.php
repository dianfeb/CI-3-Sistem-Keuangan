...
class Transaksi extends CI_Controller
{
	...
	function getKeuangan()
	{
		...
		foreach ($get as $k => $v) {
			...
			$depo = $this->db->where('jenis', 'masuk')->where('id_pelanggan', $v['id_pelanggan'])->get('tbl_keuangan')->result();
			$tarik = $this->db->where('jenis', 'keluar')->where('id_pelanggan', $v['id_pelanggan'])->get('tbl_keuangan')->result();
	...
	function crud_keuangan()
	{
		...
		if ($data_post['jenis_transaksi'] == 'tunai' && $data_post['jenis'] == 'masuk') {
		...
		} else if (($data_post['jenis_transaksi'] == 'transfer' && $data_post['jenis'] == 'masuk')) {
			$data = array(
				'table_name' => 'tbl_keuangan',
				'id_keuangan' => $data_post['id_keuangan'],
				'id_pelanggan' => $data_post['nasabah'],
		...
		} else if (($data_post['jenis_transaksi'] == 'tunai' && $data_post['jenis'] == 'keluar')) {
			$data = array(
				'table_name' => 'tbl_keuangan',
				'id_keuangan' => $data_post['id_keuangan'],
				'id_pelanggan' => $data_post['nasabah'],
		...
		} else if (($data_post['jenis_transaksi'] == 'transfer' && $data_post['jenis'] == 'keluar')) {
			$data = array(
				'table_name' => 'tbl_keuangan',
				'id_keuangan' => $data_post['id_keuangan'],
				'id_pelanggan' => $data_post['nasabah'],
	...
	public function sisa_saldo()
	{
		...
		$depo = $this->db->where('jenis', 'masuk')->where('id_pelanggan', $id)->get('tbl_keuangan')->result();
		$tarik = $this->db->where('jenis', 'keluar')->where('id_pelanggan', $id)->get('tbl_keuangan')->result();
